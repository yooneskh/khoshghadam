...
export function ensureBody<const def>(args: { event: H3Event, schema: type.validate<def> }): Promise<type.infer.Out<def>>;
export async function ensureBody(args: { event: H3Event, schema: unknown }): Promise<unknown> {
